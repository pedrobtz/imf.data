...
- A concise workflow that discovers datasets and returns tidy observations.
- Raw `sdmx_*()` functions for users who need the complete SDMX response.
...
The SDMX 3.0 rewrite is available from GitHub while version 0.2.0 is under
development:
